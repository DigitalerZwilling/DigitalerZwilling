...
public class Gelenk {
    ...
    public Gelenk( long id_Gelenk, String gelenktyp, int nummer, int gelenkstellung, Timestamp zeitstempel, String user_Paameter) {
    ...
    public String toString() {
        return super.toString()+"  :  Gelenk{"  + ", id_Gelenk=" + id_Gelenk + ", gelenktyp=" + gelenktyp + ", nummer=" + nummer + ", gelenkstellung=" + gelenkstellung + ", zeitstempel=" + zeitstempel + ", user_Paameter=" + user_Paameter + '}';
    }
